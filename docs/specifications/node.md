...
Concrete JSON shape for the structured properties above. A fully annotated worked example (Samsung Galaxy Tab, SHW-M380W) is at `docs/specifications/examples/node_example.jsonc`.
...
A fully worked example (Samsung Galaxy Tab, SHW-M380W) is available at `docs/specifications/examples/node_example.jsonc`.
